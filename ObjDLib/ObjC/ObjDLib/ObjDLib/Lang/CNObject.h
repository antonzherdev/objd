...
@protocol CNComparable <NSObject>
- (NSInteger)compareTo:(id)to;
@end

@interface NSNumber(ODObject)<CNComparable>
- (NSInteger)compareTo:(id)to;
@end
...
static inline CGFloat cnFloatRndMinMax(CGFloat s, CGFloat e) {
    return (CGFloat)drand48() * (e - s) + s;
}

static inline CGFloat cnFloatRnd() {
    return (CGFloat)drand48();
}

static inline float cnFloat4RndMinMax(float s, float e) {
    return (float)drand48() * (e - s) + s;
}

static inline float cnFloat4Rnd() {
...
static inline NSUInteger cnuIntRndMax(NSUInteger max) {
    return arc4random_uniform((u_int32_t)(max + 1));
}


static inline NSUInteger cnuIntRnd() {
    return arc4random();
}
...
static inline CGFloat cnFloatMax() {
    return OD_DBL_MAX;
}

static inline CGFloat cnFloatMin() {
    return -OD_DBL_MAX;
}

static inline float cnFloat4Max() {
    return OD_FLT_MAX;
}

static inline float cnFloat4Min() {
    return -OD_FLT_MAX;
}
