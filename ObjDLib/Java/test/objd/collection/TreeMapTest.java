...
public class TreeMapTest extends TestCase {
    ...
    public void testMain() {
        ...
        map.setKeyValue(0, "objd/test");
        final String __tmp_4p1n = map.applyKey(0);
        if(__tmp_4p1n == null) {
            throw new NullPointerException();
        }
        PackageObjectTest.<String>assertEqualsAB("objd/test", __tmp_4p1n);
        ...
        tests.chain().distinct().forEach(new P<Integer>() {
            ...
            public void apply(final Integer i) {
                ...
                PackageObjectTest.<String>assertEqualsAB("objd/test" + i, __tmp_8rp1n);
            }
        });
        ...
        tests.chain().distinct().forEach(new P<Integer>() {
            ...
            public void apply(final Integer i) {
                ...
                PackageObjectTest.<String>assertEqualsAB("objd/test" + i, __tmp_10r_0p1n);
                map.removeKey(i);
