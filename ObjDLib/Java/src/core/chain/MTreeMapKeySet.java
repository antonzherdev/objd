...
public class MTreeMapKeySet<K> implements TreeMapKeySet<K> {
    public final MTreeMap<K, Object> map;
    public int count() {
        return ERROR: Unknown <MTreeMapKeySet#C<K#G>>self.<eIUw>map\MTreeMap#C<§K#G§, ^_>\.<dIo>count\uint\;
    }
    public Iterator<K> iterator() {
        return ERROR: Unknown <to>TreeMapKeyIterator\TreeMapKeyIterator#C.class\.<dIt>apply(map = <MTreeMapKeySet#C<K#G>>self.<eIUw>map\MTreeMap#C<§K#G§, ^_>\, entry = <MTreeMapKeySet#C<K#G>>self.<eIUw>map\MTreeMap#C<§K#G§, ^_>\.<rdI>firstEntry\(^TreeMapEntry#C<§K#G§, §^_§>)?\)\TreeMapKeyIterator#C<§K#G§>\;
    }
    public MIterator<K> mutableIterator() {
        return ERROR: Unknown <to>MTreeMapKeyIterator\MTreeMapKeyIterator#C.class\.<dIt>apply(map = <MTreeMapKeySet#C<K#G>>self.<eIUw>map\MTreeMap#C<§K#G§, ^_>\, entry = <MTreeMapKeySet#C<K#G>>self.<eIUw>map\MTreeMap#C<§K#G§, ^_>\.<rdI>firstEntry\(^TreeMapEntry#C<§K#G§, §^_§>)?\)\MTreeMapKeyIterator#C<§K#G§>\;
    }
    public Iterator<K> iteratorHigherThanKey(K key) {
        return ERROR: Unknown <to>MTreeMapKeyIterator\MTreeMapKeyIterator#C.class\.<dIt>apply(map = <MTreeMapKeySet#C<K#G>>self.<eIUw>map\MTreeMap#C<§K#G§, ^_>\, entry = <MTreeMapKeySet#C<K#G>>self.<eIUw>map\MTreeMap#C<§K#G§, ^_>\.<rdp>higherEntryThan(key = <l>key\§K#G§\)\(^TreeMapEntry#C<§K#G§, §^_§>)?\)\MTreeMapKeyIterator#C<§K#G§>\;
    }
    public MTreeMapKeySet(MTreeMap<K, Object> map) {
    }
    static final ClassType<MTreeMapKeySet<K>> type;
